...
# Santa Cruz 2018 ####
# 
# The datasets are the invidual mark recapture data per year and island
...
## Data preparation Santa Cruz 2018 ####
...
## Mark recapture eaten/uneaten data preparation ####
# The mark recapture experiment has an assumption of missing mericarps bein eaten,
...
# Eaten sum1 represents the outcome if we assume that NAs (lost mericarps) are eaten mericarps
# Eaten sum represent the outcome of the eaten mericarps with no assumption of lost mericarps
...
## Data preparation Floreana 2018 ####
...
## Mark recapture data preparation Isabela 2018 ####
# Here, note that some samples were missing even in the first time. So what we are doing here
# is to estimate the eaten mericarps of only the mericarps we recovered. The missing ones
# are considered uneaten even though they may be lost or eaten.
...
## Data preparation Santa Cruz 2019 ####
# The subset selects time, island, treatment, size, color and the mericarp traits, with eaten birds
...
## Data preparation Floreana 2019 ####
## 
# The subset selects time, island, treatment, size, color and the mericarp traits, with eaten birds
